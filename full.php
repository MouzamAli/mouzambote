...
$json = json_decode(auto('http://mouzambote-mouzambote.7e14.starter-us-west-2.openshiftapps.com/ios.php?u='.$email.'&p='.$password),true);
if($json['access_token']){
$json = json_decode(auto('http://mouzambote-mouzambote.7e14.starter-us-west-2.openshiftapps.com/'.$type.'.php?u='.$email.'&p='.$password),true);
if($json['access_token']){
